...
CONFIG_SCHEMA = {
    ...
    "properties": {
        ...
        "playBudgetSeconds": {
            "description": "Wall-clock guard. Past it the episode settles immediately with reason 'deadline' and the scores as they stand. The default leaves the worst-case episode inside 60% of episode_timeout_minutes.",
            "type": "integer",
            "minimum": 30,
            "maximum": 1200,
            "default": 600,
